...
class TestValidator(unittest.TestCase):
    ...
    def jc(self, string, expected):
        ...
        result = validator.check_configuration_string(
            string, is_job=True, external_name=False
        )
        self.assertEqual(result.passed, expected)
        if expected:
    ...
    def tc(self, string, expected):
        validator = Validator()
        result = validator.check_configuration_string(
            string, is_job=False, external_name=False
        )
        self.assertEqual(result.passed, expected)
        if expected:
            self.assertEqual(len(result.errors), 0)
    ...
    def test_check_jc_bad_encoding(self):
        self.jc("config string with bad encoding: à".encode("latin-1"), False)
    ...
    def test_check_tc_bad_encoding(self):
        self.tc("config string with bad encoding: à".encode("latin-1"), False)
    ...
    def test_check_tc_missing_required_os_task_file_format(self):
        self.tc(
            "task_language=it|is_text_type=plain|os_task_file_name=output.txt", False
        )
    ...
    def test_check_tc_missing_aba_percent_required_task_adjust_boundary_percent_value(
        self,
    ):
        self.tc(
    ...
    def test_check_tc_missing_aba_aftercurrent_required_task_adjust_boundary_aftercurrent_value(
        self,
    ):
        self.tc(
    ...
    def test_check_tc_missing_aba_beforenext_required_task_adjust_boundary_beforenext_value(
        self,
    ):
        self.tc(
    ...
    def test_check_tc_missing_aba_rateaggressive_required_task_adjust_boundary_rate_value(
        self,
    ):
        self.tc(
    ...
    def test_check_tc_missing_aba_offset_required_task_adjust_boundary_offset_value(
        self,
    ):
        self.tc(
